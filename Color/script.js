...
function ApplyInfo(a = water) {
    if (!won) {
        ...
        level.innerHTML+=`<div id = "restart" class = "game-buttons" onclick = "Restart();">De Nuevo</div><div id = "home" class = "game-buttons" onclick = "ShowMenu();">Inicio</div><div id = "moves">Moves: ${moves}</div>`;
    }
}
...
function Won() {
    ...
    won=true;
    //console.log("hello");
    level.innerHTML = `<div id="won">Ganaste</div><div id = "restart" class = "game-buttons" onclick = "Restart();">RESTART</div><div id = "home" class = "game-buttons" onclick = "ShowMenu();">INICIO</div>`;
}
